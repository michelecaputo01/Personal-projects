...
matplot(k_values, theta_matrix, type = 'p', xaxt = 'n', pch = 19, cex = 1.2, ylab = expression(theta), 
        col = colors, main = "PSD (sim) - Theta values", ylim = c(0,1), xlab = "Number of clusters")
...
############## Example with k = 4 and ngroups = 150 #################
...
plot_grid(gridSizeX, gridSizeY, final_cluster, title = paste("CLR + PSD, hard - KPI =", kpi_value),
