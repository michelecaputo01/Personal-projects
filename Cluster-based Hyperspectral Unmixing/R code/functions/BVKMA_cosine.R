BVKMA_cosine = function(data, gridSizeX, gridSizeY, n, k, B, print = FALSE){
  ...
  for(b in 1:B){
    ...
    local_cluster = boot_iter_cosine(data, n, k, grid_points, print)
  ...
  theta = compute_theta_cosine(data, final_clusters)
