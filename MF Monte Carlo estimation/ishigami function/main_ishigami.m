...
title([method,' main sensitivity estimates for Ishigami function(p=4000)'],'interpreter','latex')
...
if strcmp(method,'Owen') || strcmp(method,'Saltelli')
    ...
    bp = gca;   bp.XAxis.TickLabelInterpreter = 'latex';
    title([method,' total sensitivity estimates for Ishigami function(p=4000)'],'interpreter','latex')
end
...
title('Variance estimates for Ishigami function(p=4000)','interpreter','latex')